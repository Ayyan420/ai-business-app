    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600 mt-1">Your centralized command center for AI-powered business tools</p>
        </div>
          ...
          {quickActions.map((action) => {
            ...
            return (
              <button
                ...
                className="p-4 border border-slate-200 rounded-lg hover:border-blue-300 hover:shadow-md transition-all duration-200 text-left group"
              >
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
        ...
        {loading ? (
          <div className="text-center py-8">
            ...
            <p className="text-slate-600 mt-2">Loading activity...</p>
          </div>
        ) : (
          <div className="space-y-4">
            {recentActivity.length > 0 ? recentActivity.map((activity, index) => (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-sm text-slate-500">Start using the tools to see activity here</p>
              </div>
            )}
          </div>
        )}
